...
public class InventoryStorageUtil {
     ...
     */
    public static InventoryStorageUtil $() {
        return instance;
    }
    ...
    public final void restore(Player player) {
        ...
        //player.setMaxHealth(s.getMaxHealth()); deprecated
        player.getAttribute(Attribute.GENERIC_MAX_HEALTH).setBaseValue(s.getMaxHealth());
    ...
    private StoredInventory getStored(Player pl) {
